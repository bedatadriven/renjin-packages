...
{
    public static final Logger log = Logger.getLogger(ProxyDownload.class.getName());
    ...
    public void download () throws IOException, DownloadFailed
    {
        ...
        if (statusFile.exists())
        {
            ...
            {
                log.log(Level.WARNING, "Error writing 'File not found'-Status to "+statusFile.getAbsolutePath(), e);
            }
        }
        ...
        log.info("Downloading to "+dest.getAbsolutePath());
        ...
        try
        {
            ...
            if (0 == 1 && log.isLoggable(Level.FINE))
            {
