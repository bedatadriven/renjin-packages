...
public class ProjectBuilder {
  ...
  private void writeBuildFile(PackageNode packageNode, File packageDir, PrintWriter writer) {
    ...
    if(needsCompilation) {
      ...
      // If we are linking against other packages, ensure their make process runs first so
      // that any generated files are available

//      if (!Iterables.isEmpty(description.getLinkingTo())) {
//        writer.println();
//        writer.println("renjin {");
//        writer.print("  linkingTo = [");
//        boolean needsComma = false;
//        for (PackageDependency dependency : description.getLinkingTo()) {
//          PackageNode node = dependencyMap.get(dependency.getName());
//          if (node != null && !node.isProvided()) {
//            if (needsComma) {
//              writer.print(", ");
//            }
//            writer.print("':cran:" + node.getId().getPackageName() + "'");
//            needsComma = true;
//          }
//        }
//        writer.println("]");
...
//    writer.println("  compile \"org.renjin:renjin-core:" + renjinVersion + "\"");
//    for (String defaultPackage : CorePackages.CORE_PACKAGES) {
//      if(!defaultPackage.equals("base")) {
//        writer.println("  compile \"org.renjin:" + defaultPackage + ":" + renjinVersion + "\"");
//      }
//    }
